...
List<SinglePhotoModel> photoListFromJson(String str) {
  List list = jsonDecode(str);
  List<SinglePhotoModel> listPhoto = list.map((item) => SinglePhotoModel.fromJson(item)).toList();
  return listPhoto;
}
String photoListToJson(List<SinglePhotoModel> data) => jsonEncode(data.map((e) => e.toJson()).toList());


SinglePhotoModel photoFromJson(String str) => SinglePhotoModel.fromJson(json.decode(str));
String photoToJson(SinglePhotoModel data) => json.encode(data.toJson());
